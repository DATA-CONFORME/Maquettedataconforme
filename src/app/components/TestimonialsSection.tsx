      ...
      <div className="max-w-[1200px] mx-auto px-8 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          <div className="max-w-[600px]">
            ...
            <h2 className="font-['Manrope:Bold',sans-serif] text-[40px] md:text-[48px] text-white leading-tight">
              Ils nous font confiance <br className="hidden md:block" /> pour leur conformité.
            </h2>
          </div>
